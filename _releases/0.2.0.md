...
---
# Version 0.2.0: Refactors, Enhancements, and Pipes
...
**Docs!**  They [actually exist now](https://hexdocs.pm/otpcl/).  Quite a few functions have typespecs, but I gave up midway and am probably going to rework how I'm doing them (right now they're all defined in `otpcl.hrl`, which is kinda sloppy).  Nearly every public function, however, *does* have at least some degree of documentation.
